package com.sany.imagevideo.jcamera;
...
import com.sany.imagevideo.jcamera.util.CameraParamUtil;
import com.sany.imagevideo.jcamera.util.CheckPermission;
import com.sany.imagevideo.jcamera.util.DeviceUtil;
import com.sany.imagevideo.jcamera.util.FileUtil;
import com.sany.imagevideo.jcamera.util.ScreenUtils;
    ...
    private synchronized void openCamera(int id) {
        ...
        if (Build.VERSION.SDK_INT > 17 && this.mCamera != null) {
            try {
                ...
                e.printStackTrace();
                Log.e("ID", "enable shutter sound faild");
            }
        }
    }
...
//
    ...
    public void startRecord(Surface surface, float screenProp, ErrorCallback callback) {
        ...
        try {
            ...
            e.printStackTrace();
            Log.i("ID", "startRecord IllegalStateException");
            if (this.errorLisenter != null) {
                this.errorLisenter.onError();
            }
        } catch (IOException e) {
            e.printStackTrace();
            Log.i("ID", "startRecord IOException");
            if (this.errorLisenter != null) {
                this.errorLisenter.onError();
            }
        } catch (RuntimeException e) {
            Log.i("ID", "startRecord RuntimeException");
        }
    }
